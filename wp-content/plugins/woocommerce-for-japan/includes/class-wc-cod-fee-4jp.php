                ...
                <tr valign="top">
                    ...
                    <td class="forminp">
                        <fieldset>
                            ...
                            <input class="input-text regular-input " type="text" name="woocommerce_cod_extra_charge_name" id="woocommerce_cod_extra_charge_name" value="<?php echo $fee_name ?>" placeholder="<?php _e( 'COD Payment method fee', 'woocommerce-for-japan' ) ?>">
                        </fieldset>
                    </td>
                </tr>
                <tr valign="top">
